...
class MultiFacetedAttention(nn.Module):
    def __init__(self, hidden_size: int) -> None:
        ...
        self.thematic_attn = nn.MultiheadAttention(hidden_size, num_heads=8, batch_first=True)
        self.emotional_attn = nn.MultiheadAttention(hidden_size, num_heads=8, batch_first=True)
        self.contextual_attn = nn.MultiheadAttention(hidden_size, num_heads=8, batch_first=True)
